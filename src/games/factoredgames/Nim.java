...
public class Nim extends AbstractGame{
    ...
    /**
     * prends le nombre d'allumettes à retirer et les soustrait du nombre d'allulmettes courant
     * appelle isValide pour verifier si le nombre est valide ou pas
     * @param nbMatches nombres d'allumettes à retirer
     */
    @Override
